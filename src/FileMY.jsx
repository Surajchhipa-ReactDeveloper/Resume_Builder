  ...
  const generatePDF = () => {
    ...
    const html = `
      ...
      <p style="color: blue;">
        ...
        reiciendis expedita, placeat voluptatum accusamus consectetur voluptates
        fugiat illo labore magnam cupiditate iusto cumque illum optio neque
        similique eum alias aperiam.
      </p>
    `;
